# -*- coding: utf-8 -*-
# main process of training data for owner
...
from owner_input import extract_data, resize_with_pad, IMAGE_SIZE
...
class Dataset(object):
    ...
    def read(self, img_rows=IMAGE_SIZE, img_cols=IMAGE_SIZE, img_channels=3, nb_classes=2):
        ...
        # data being shuffled and split between train and test sets
...
class Model(object):
    ...
    def train(self, dataset, batch_size=32, nb_epoch=40, data_augmentation=True):
        # train the model using SGD + momentum (original).
